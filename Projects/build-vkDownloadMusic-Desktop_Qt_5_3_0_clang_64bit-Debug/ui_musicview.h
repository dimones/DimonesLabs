...
public:
    ...
    void setupUi(QWidget *MusicView)
    {
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/new/prefix1/1400113331_icon-ios7-arrow-back.png"), QSize(), QIcon::Normal, QIcon::On);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral("../../../../Downloads/1400113310_icon-play.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon2.addFile(QStringLiteral(":/new/prefix1/1400113310_icon-play.png"), QSize(), QIcon::Normal, QIcon::On);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/new/prefix1/1400113325_icon-ios7-arrow-forward.png"), QSize(), QIcon::Normal, QIcon::Off);
        next->setIcon(icon3);
        ...
        curPlaySong->setGeometry(QRect(20, 20, 351, 41));
        curPlaySong->setTextFormat(Qt::AutoText);
