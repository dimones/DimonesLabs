...
{
    ui->setupUi(this);
    ui->webView->load(QUrl("https://oauth.vk.com/authorize?client_id=4258201&scope=audio&redirect_uri=https://oauth.vk.com/blank.html&display=popup&v=5.21&response_type=token"));
...
void MainWindow::check_url(QUrl url)
{
    ...
    if(!s.contains("access_token"))
            return;
    qDebug() << "fsa"<< QUrlQuery(s).toString();
